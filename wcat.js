...
//const { allowedNodeEnvironmentFlags, listeners } = require("process")

//read multiple files
// wcat -s filepath > convert big line breaks into singular breaks
// wcat -n filepath> give numbering to all
// wcat -b filepath> give numbering to non empty lines
// wcat filename> append all the content
// wcat -s filename1>filename2> remove spaces and append file in file2
// if n and b are given execute first command
let fs = require("fs");
// input
